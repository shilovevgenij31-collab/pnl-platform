...
const GOLDRATT_TEST_FILL: Partial<AnalyzeFormFields> = {
  ...
  revenueMechanics:
    'Проектные работы: создание курсов, упаковка, лендинги, воронки, AI-решения. Смешанная модель — разовые проекты и повторные клиенты.',
...
const REVENUE_KEYWORDS = [
  ...
  'товарооборот', 'выручка / оборот', 'итого выручка', 'валовая выручка',
...
const EXPENSE_KEYWORDS = [
  ...
  'логистика', 'хранение', 'комиссия', 'комиссии маркетплейса',
...
const PROFIT_KEYWORDS = [
  ...
  'операционная прибыль', 'ebitda', 'прибыль/убыток', 'прибыль / убыток',
...
const GOLDRATT_STEPS = [
  ...
  'Анализируем поток, очередь и операционную нагрузку...',
  'Ищем симптомы системы...',
  'Определяем главное ограничение...',
  'Проверяем гипотезу ограничения...',
  'Строим 5 шагов теории ограничений...',
